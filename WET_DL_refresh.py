...
cols = ["BattV_Avg", "RH_Avg", "TA_Avg", "e_sat_probe_Avg", "e_probe_Avg", "VPD_Avg", "T_SOIL_Avg", "T_CANOPY_Avg", "WP_Avg",
        ...
        "SWC_1_7_1_Avg", "SWC_1_8_1_Avg", "Ka_1_1_1_Avg", "Ka_1_2_1_Avg", "Ka_1_3_1_Avg", "Ka_1_4_1_Avg",
        "Ka_1_5_1_Avg", "Ka_1_6_1_Avg", "Ka_1_7_1_Avg", "Ka_1_8_1_Avg", "TS_1_1_1_Avg", "TS_1_2_1_Avg",
        "TS_1_3_1_Avg", "TS_1_4_1_Avg", "TS_1_5_1_Avg", "TS_1_6_1_Avg", "TS_1_7_1_Avg", "TS_1_8_1_Avg",
        "SEC_1_1_1_Avg", "SEC_1_2_1_Avg", "SEC_1_3_1_Avg", "SEC_1_4_1_Avg", "SEC_1_5_1_Avg", "SEC_1_6_1_Avg",
        "SEC_1_7_1_Avg", "SEC_1_8_1_Avg", "SW_IN_Avg", "SW_OUT_Avg", "LW_IN_Avg", "LW_OUT_Avg", "NETRAD_Avg",
  ...
  for name in path.glob("*"+sites[i]+"*.dat"):
    if str(name).split(".")[0].split("_")[-1] == "General":
      ...
      if sites[i] == "WET01":
        ...
        temp = temp[["TIMESTAMP", "BattV_Avg", "RH_Avg", "TA_Avg", "e_sat_probe_Avg", "e_probe_Avg",
                        "VPD_Avg", "T_SOIL_Avg", "T_CANOPY_Avg", "WP_Avg"]]
      temp["site"] = sites[i]
      ...
      temp = temp[["TIMESTAMP", "SWC_1_1_1_Avg", "SWC_1_2_1_Avg", "SWC_1_3_1_Avg", "SWC_1_4_1_Avg",
                "SWC_1_5_1_Avg", "SWC_1_6_1_Avg", "SWC_1_7_1_Avg", "SWC_1_8_1_Avg",
                "Ka_1_1_1_Avg", "Ka_1_2_1_Avg", "Ka_1_3_1_Avg", "Ka_1_4_1_Avg",
                "Ka_1_5_1_Avg", "Ka_1_6_1_Avg", "Ka_1_7_1_Avg", "Ka_1_8_1_Avg",
                "TS_1_1_1_Avg", "TS_1_2_1_Avg", "TS_1_3_1_Avg", "TS_1_4_1_Avg",
                "TS_1_5_1_Avg", "TS_1_6_1_Avg", "TS_1_7_1_Avg", "TS_1_8_1_Avg",
                "SEC_1_1_1_Avg", "SEC_1_2_1_Avg", "SEC_1_3_1_Avg", "SEC_1_4_1_Avg",
                "SEC_1_5_1_Avg", "SEC_1_6_1_Avg", "SEC_1_7_1_Avg", "SEC_1_8_1_Avg"]]
      temp["site"] = sites[i]
